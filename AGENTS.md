# WellCore Laravel — Agent Context
...
The following Kimi skills are installed locally in `.kimi/skills/`:

- **wellcore-workout-plans** — Create personalized workout plans for Wellcore clients
- **proway-brand-standards** — Apply Proway Lab brand guidelines to all content
- **proway-project-docs** — Generate project documentation with Proway branding
- **proway-proposal-builder** — Build client proposals with Proway methodology
- **proway-social-content-v2** — Create social media content for fitness brands
- **proway-instagram-mastery** — Instagram-specific content strategies and playbooks
