...
$scriptBody = '{"json":{"projectName":"wellcorefitness","serviceName":"wellcorefitness","name":"check-fillable","content":"cd /var/www/html && php artisan tinker --execute=\"echo implode(\\\",\\\", (new App\\\\Models\\\\WorkoutLog)->getFillable());\"}}'
...
Write-Output "=== WorkoutLog fillable in production ==="
