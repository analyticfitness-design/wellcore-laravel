<x-layouts.public>
    ...
    <section class="bg-wc-bg">
        <div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8"
            ...
            {{-- Tab Navigation --}}
            <div class="mb-8 flex overflow-x-auto gap-2 pb-2">
                <button
            ...
            {{-- TAB 2: PLANES --}}
            {{-- ============================================================ --}}
            <div x-show="tab === 'planes'" x-cloak class="space-y-4">
            ...
            {{-- TAB 3: PAGOS --}}
            {{-- ============================================================ --}}
            <div x-show="tab === 'pagos'" x-cloak class="space-y-4">
            ...
            {{-- TAB 4: ENTRENAMIENTO --}}
            {{-- ============================================================ --}}
            <div x-show="tab === 'entrenamiento'" x-cloak class="space-y-4">
            ...
            {{-- TAB 5: SOPORTE --}}
            {{-- ============================================================ --}}
            <div x-show="tab === 'soporte'" x-cloak class="space-y-4">
    ...
    <section class="bg-wc-bg-tertiary">
        <div class="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
            ...
            <div class="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <a href="https://wa.me/573001234567" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 rounded-lg border border-wc-border px-8 py-3 text-base font-medium text-wc-text hover:bg-wc-bg-secondary">
