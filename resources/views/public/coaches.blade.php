<x-layouts.public>
    ...
    <section class="bg-wc-bg-tertiary">
        <div class="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 sm:py-28 lg:px-8">
            ...
            <h1 class="mt-6 font-display text-4xl tracking-wide text-wc-text sm:text-5xl lg:text-6xl">SÉ COACH WELLCORE</h1>
        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-3xl">
                ...
                <div class="mt-10 space-y-4">
                    <div class="flex items-start gap-4 rounded-lg border border-wc-border bg-wc-bg-tertiary p-5">
