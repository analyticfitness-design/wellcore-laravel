    ...
    <section class="border-y border-wc-border bg-wc-bg">
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-6 sm:grid-cols-4">
                ...
                <div class="text-center">
                    <p class="font-data text-3xl font-bold text-wc-accent">12</p>
            ...
            <div class="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                ...
                <a href="#fase-04" class="flex shrink-0 items-center gap-3 rounded-full border border-wc-border bg-wc-bg px-5 py-3 transition-colors hover:border-wc-accent/40">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-wc-text-tertiary">Semana 12+</p>
                    </div>
                </a>
            </div>
        </div>
                ...
                <div class="lg:col-span-2">
                    <div class="rounded-xl border border-wc-border bg-wc-bg-tertiary p-6">
                        ...
                        <ul class="mt-5 space-y-3">
                            ...
                            <li class="flex items-start gap-3 text-sm text-wc-text-secondary">
                                <span class="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded bg-wc-accent/10 text-xs font-bold text-wc-accent">4</span>
                                Acceso a tu portal de cliente con tus datos cargados
                            </li>
                            <li class="flex items-start gap-3 text-sm text-wc-text-secondary">
                                <span class="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded bg-wc-accent/10 text-xs font-bold text-wc-accent">5</span>
    ...
    <section id="fase-04" class="bg-wc-bg-tertiary scroll-mt-20">
        <div class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="rounded-xl border border-wc-accent/30 bg-wc-accent/5 p-5 text-center">
                    <p class="font-data text-2xl font-bold text-wc-accent">87%</p>
                    <p class="mt-1 text-xs text-wc-text-secondary">Adherencia promedio</p>
                </div>
                <div class="rounded-xl border border-wc-accent/30 bg-wc-accent/5 p-5 text-center">
                    <p class="font-data text-2xl font-bold text-wc-accent">74%</p>
