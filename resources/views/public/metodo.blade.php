    ...
    <section class="border-y border-wc-border bg-wc-bg">
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
                ...
                <div class="text-center">
                    <p class="font-data text-4xl font-bold text-wc-accent">12 sem</p>
        ...
        <div class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 rounded-xl border border-wc-accent/20 bg-wc-accent/5 p-6 sm:p-8">
                <p class="text-lg font-medium text-wc-text">
                    El <span class="font-data text-2xl font-bold text-wc-accent">80%</span> de las personas que comienzan un programa de ejercicio lo abandonan antes de los 3 meses. No es falta de voluntad. Es falta de estructura cientifica.
                </p>
            </div>
            ...
            <div class="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-5 sm:gap-6">
                ...
                <div class="rounded-xl border border-wc-border bg-wc-bg p-5 text-center">
                    <p class="font-data text-2xl font-bold text-wc-text">67%</p>
                    <p class="mt-1 text-xs text-wc-text-tertiary">Abandono semanas 1-4</p>
                </div>
                <div class="rounded-xl border border-wc-border bg-wc-bg p-5 text-center">
                    <p class="font-data text-2xl font-bold text-wc-text">54%</p>
    ...
    <section class="bg-wc-bg">
        <div class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            ...
            <div class="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="group rounded-xl border border-wc-border bg-wc-bg-tertiary p-8 transition-colors hover:border-wc-accent/40">
