<div>
    ...
    >
        ...
        <div class="relative mx-4 w-full max-w-sm rounded-2xl border border-wc-border bg-wc-bg p-6 shadow-2xl"
             @click.outside="$wire.closeTimer()">

            {{-- Close button --}}
            <button @click="$wire.closeTimer()" class="absolute right-4 top-4 text-wc-text-tertiary hover:text-wc-text transition-colors" aria-label="Cerrar timer">
