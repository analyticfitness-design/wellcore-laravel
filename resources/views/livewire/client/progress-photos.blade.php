<div
    x-data="{
        showOverlay: @entangle('showSuccess'),
        confetti: false,
        init() {
            this.$watch('showOverlay', v => { if (v) { this.confetti = true; setTimeout(() => this.confetti = false, 4000); } });
        }
    }"
>
    {{-- ===== ACHIEVEMENT OVERLAY: FOTOS ===== --}}
    <style>
        ...
        >
            ...
            <div class="relative z-10 p-8">
                ...
                <div class="my-5 rounded-xl border border-white/10 bg-white/[0.06] px-5 py-4">
                    <p class="font-data text-3xl font-bold text-white">+3</p>
