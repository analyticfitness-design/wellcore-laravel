    ...
    <div class="w-full max-w-md">
        <div class="rounded-2xl border border-wc-border bg-wc-bg-tertiary p-8 shadow-xl sm:p-10">
            ...
            <div class="my-6 flex items-center gap-3">
                ...
                <span class="text-xs text-wc-text-tertiary">o continua con</span>
                <span class="h-px flex-1 bg-wc-border"></span>
            </div>
            ...
            <a
                ...
                class="flex w-full items-center justify-center gap-3 rounded-full border border-wc-border bg-wc-bg-secondary px-4 py-3 text-sm font-medium text-wc-text-secondary transition-colors hover:bg-wc-bg"
            >
