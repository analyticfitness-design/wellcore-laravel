        ...
        <div class="flex items-center justify-center p-8 sm:p-10">
            <div class="w-full max-w-sm">
                ...
                <a
                    ...
                    class="flex w-full items-center justify-center gap-3 rounded-xl border border-wc-border bg-wc-bg-secondary px-4 py-3 text-sm font-medium text-wc-text-secondary transition-colors hover:bg-wc-bg"
                >
