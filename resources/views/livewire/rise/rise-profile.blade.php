<div class="space-y-6">
    ...
    <div class="rounded-xl border border-wc-border bg-wc-bg-tertiary p-5 sm:p-6">
        <div class="flex items-center gap-4">
            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-wc-accent/30 to-wc-accent/20">
                <span class="font-display text-2xl text-wc-accent">{{ $initial }}</span>
            </div>
                ...
                @if($status)
                    @php
                        $statusColor = match($status) {
                            ...
                            'paused' => 'bg-wc-accent/10 text-wc-accent',
    ...
    <div class="rounded-xl border border-wc-border bg-wc-bg-tertiary p-5">
        <div class="flex items-center justify-between">
            ...
            <span class="font-data text-2xl font-bold text-wc-accent">{{ $progressPercent }}%</span>
        </div>
