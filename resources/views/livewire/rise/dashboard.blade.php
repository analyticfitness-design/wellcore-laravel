<div class="space-y-6">
            ...
            <div class="relative">
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-2 flex items-center justify-between text-xs text-wc-text-tertiary">
                        <span>Dia {{ $daysElapsed }} de {{ $totalDays }}</span>
    ...
    <div class="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-card border border-wc-border bg-wc-bg-tertiary p-4 sm:p-5">
            ...
            <p class="mt-3 font-data text-3xl font-bold text-wc-text">{{ $currentStreak }}</p>
        ...
        <div class="rounded-card border border-wc-border bg-wc-bg-tertiary p-4 sm:p-5">
            ...
            <p class="mt-3 font-data text-3xl font-bold text-wc-text">{{ $workoutsThisWeek }}</p>
        ...
        <div class="rounded-card border border-wc-border bg-wc-bg-tertiary p-4 sm:p-5">
            ...
            <p class="mt-3 font-data text-3xl font-bold text-wc-text">{{ $overallAdherence }}%</p>
        ...
        <div class="rounded-card border border-wc-border bg-wc-bg-tertiary p-4 sm:p-5">
            ...
            @if($latestWeight)
                <p class="mt-3 font-data text-3xl font-bold text-wc-text">{{ $latestWeight }}</p>
                <p class="mt-0.5 text-xs text-wc-text-tertiary">
                    kg
                    @if($weightChange !== null)
                        <span class="{{ $weightChange < 0 ? 'text-emerald-500' : ($weightChange > 0 ? 'text-wc-accent' : '') }}">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div class="rounded-card border border-wc-border bg-wc-bg-tertiary p-5 lg:col-span-2">
            ...
            <p class="mt-1 text-xs text-wc-text-tertiary">Semana {{ now()->isoWeek() }} — Tracking diario</p>
            ...
            <div class="mt-4 space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-data text-sm font-semibold text-wc-text">{{ $workoutsThisWeek }}/7</span>
                    </div>
                    <div class="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-wc-bg-secondary">
                        <div class="h-full rounded-full bg-emerald-500 transition-all" style="width: {{ min(100, ($workoutsThisWeek / 7) * 100) }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-data text-sm font-semibold text-wc-text">{{ $habitsCompletedThisWeek }}/7</span>
                    </div>
                    <div class="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-wc-bg-secondary">
                        <div class="h-full rounded-full bg-sky-500 transition-all" style="width: {{ min(100, ($habitsCompletedThisWeek / 7) * 100) }}%"></div>
                    </div>
                </div>
