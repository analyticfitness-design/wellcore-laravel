        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 pb-8 space-y-6">
            ...
            <div>
                ...
                <ul class="space-y-0.5">
                    ...
                    @endif
                    <li>
                        <a wire:navigate href="{{ route('admin.campaign-tracker') }}"
                           class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200
                                  {{ request()->routeIs('admin.campaign-tracker') ? 'border-l-2 border-red-500 bg-red-500/10 text-wc-text' : 'text-wc-text-secondary hover:bg-wc-bg-tertiary hover:text-wc-text' }}">
                            <svg class="h-4.5 w-4.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
