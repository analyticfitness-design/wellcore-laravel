...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="background:#18181B;border-radius:12px;padding:40px;border:1px solid rgba(255,255,255,0.08);">
    ...
    @if(app()->getLocale() === 'en')
      ...
      <h1 style="color:#FAFAFA;font-size:24px;margin:0 0 8px 0;text-align:center;">Password Reset</h1>
      <p style="color:rgba(250,250,250,0.64);font-size:15px;line-height:1.6;margin:0 0 24px 0;text-align:center;">
        Hi <strong style="color:#FAFAFA;">{{ $name }}</strong>, we received a request to reset the password for your WellCore Fitness account.
      </p>
        ...
        <tr>
          <td style="background:rgba(220,38,38,0.06);border-radius:8px;padding:14px 16px;border-left:3px solid #DC2626;">
            <p style="color:rgba(250,250,250,0.64);font-size:13px;line-height:1.5;margin:0;">
              <strong style="color:#FAFAFA;">This link expires in 1 hour.</strong><br>
              After that time, you will need to request a new recovery link.
            </p>
          </td>
        </tr>
      </table>
        ...
        <tr>
          <td style="border-top:1px solid rgba(255,255,255,0.08);padding-top:20px;">
            <p style="color:rgba(250,250,250,0.4);font-size:12px;line-height:1.5;margin:0;">
              <strong style="color:rgba(250,250,250,0.5);">Didn't request this?</strong><br>
              If you did not request a password reset, you can safely ignore this email. Your current password will remain unchanged. No one can access your account without this link.
            </p>
          </td>
        </tr>
      </table>
  ...
  <tr><td style="padding:24px 0;text-align:center;">
    @if(app()->getLocale() === 'en')
      <p style="color:rgba(250,250,250,0.3);font-size:11px;line-height:1.5;margin:0 0 8px 0;">
        This email was sent to {{ $name }} because a password reset was requested for your WellCore Fitness account.
      </p>
    @else
      <p style="color:rgba(250,250,250,0.3);font-size:11px;line-height:1.5;margin:0 0 8px 0;">
