...
<head>
    ...
    {{-- Meta Pixel (lazy: load tras primer interaccion o 4s post-load — ahorra ~384KB en initial load, mantiene tracking) --}}
    ...
    <nav class="sticky top-0 z-50 border-b border-wc-border bg-wc-bg/80 backdrop-blur-xl">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden items-center gap-8 md:flex">
                <a href="{{ route('home') }}" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">
                    Inicio
                </a>
                <a href="{{ route('shop.catalog') }}" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text {{ request()->routeIs('shop.*') ? '!text-wc-text' : '' }}">
                    Tienda
                </a>
                <a href="{{ route('planes') }}" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">
                    Planes
                </a>
                <a href="{{ route('faq') }}" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">
                    FAQ
                </a>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    class="relative flex h-9 w-9 items-center justify-center rounded-lg border border-wc-border bg-wc-bg-secondary text-wc-text-secondary hover:text-wc-text"
                    title="Carrito"
                >
        ...
        <div x-show="mobileMenu" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" x-cloak class="border-t border-wc-border bg-wc-bg md:hidden">
            <div class="space-y-1 px-4 py-4">
                ...
                <a href="{{ route('shop.catalog') }}" class="block rounded-lg px-3 py-2 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">Tienda</a>
        ...
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                ...
                <div class="md:col-span-1">
                    ...
                    <p class="mt-4 text-sm text-wc-text-tertiary">Suplementos y accesorios para tu mejor version.</p>
                </div>

                {{-- Links --}}
                <div>
                    <h4 class="text-sm font-semibold uppercase tracking-wider text-wc-text">Tienda</h4>
                    <ul class="mt-4 space-y-2">
                        <li><a href="{{ route('shop.catalog') }}" class="text-sm text-wc-text-secondary hover:text-wc-text">Todos los productos</a></li>
