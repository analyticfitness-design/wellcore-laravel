...
const routes = [
    ...
    { path: '/rise/training', name: 'rise-training', component: () => import('../pages/Client/TrainingView.vue'), meta: { auth: true, title: 'Entrenamiento — WellCore RISE' } },
    { path: '/rise/nutrition', name: 'rise-nutrition', component: () => import('../pages/Client/NutritionPlan.vue'), meta: { auth: true, title: 'Nutricion — WellCore RISE' } },
