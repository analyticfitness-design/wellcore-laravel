    ...
    <nav class="sticky top-0 z-50 border-b border-wc-border bg-wc-bg/80 backdrop-blur-xl">
      <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden items-center gap-5 lg:flex xl:gap-7">
          <a href="/metodo" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Metodo</a>
          <a href="/reto-rise" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">RISE</a>
          <a href="/nosotros" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Nosotros</a>
          <a href="/proceso" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Proceso</a>
          <a href="/planes" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Planes</a>
          <a href="/blog" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Blog</a>
          <a href="/faq" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">FAQ</a>
          <a href="/coaches" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Coaches</a>
          <a href="/presencial" class="text-sm font-medium text-wc-text-secondary hover:text-wc-text">Presencial</a>
        </div>
        ...
        <div class="flex items-center gap-2.5">
          ...
          <!-- Empezar CTA -->
          <a href="/inscripcion" class="hidden rounded-full bg-wc-accent px-5 py-2 text-sm font-semibold text-white hover:bg-wc-accent-hover sm:inline-flex">
            Empezar
          </a>
      ...
      >
        <div v-show="mobileMenu" class="border-t border-wc-border bg-wc-bg lg:hidden">
          <div class="space-y-1 px-4 py-4" @click="mobileMenu = false">
            <a href="/metodo" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">Metodo</a>
            <a href="/reto-rise" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">RISE</a>
            <a href="/nosotros" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">Nosotros</a>
            <a href="/proceso" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">Proceso</a>
            <a href="/planes" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">Planes</a>
            <a href="/blog" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">Blog</a>
            <a href="/faq" class="block rounded-lg px-3 py-2.5 text-sm font-medium text-wc-text-secondary hover:bg-wc-bg-secondary hover:text-wc-text">FAQ</a>
    ...
    <footer class="border-t border-wc-border bg-wc-bg-tertiary">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 items-center gap-8 border-b border-wc-border py-12 lg:grid-cols-2">
          <div>
            ...
            <div class="mt-4 flex gap-3">
              ...
              <a href="https://www.youtube.com/@Wellcorefitness" target="_blank" class="group flex h-10 w-10 items-center justify-center rounded-full bg-wc-bg-secondary text-wc-text-secondary transition-all duration-300 hover:bg-red-600 hover:text-white" aria-label="YouTube">
        ...
        <div class="grid grid-cols-2 gap-8 py-10 sm:grid-cols-4">
          <div>
            ...
            <ul class="mt-4 space-y-2.5">
              <li><a href="/metodo" class="text-sm text-wc-text-tertiary hover:text-wc-text">El Metodo</a></li>
              <li><a href="/proceso" class="text-sm text-wc-text-tertiary hover:text-wc-text">Proceso</a></li>
              <li><a href="/planes" class="text-sm text-wc-text-tertiary hover:text-wc-text">Planes</a></li>
              <li><a href="/coaches" class="text-sm text-wc-text-tertiary hover:text-wc-text">Coaches</a></li>
            </ul>
          </div>
          <div>
            <h4 class="text-xs font-semibold uppercase tracking-wider text-wc-text">Recursos</h4>
            <ul class="mt-4 space-y-2.5">
              <li><a href="/blog" class="text-sm text-wc-text-tertiary hover:text-wc-text">Blog</a></li>
              <li><a href="/faq" class="text-sm text-wc-text-tertiary hover:text-wc-text">FAQ</a></li>
              <li><a href="/nosotros" class="text-sm text-wc-text-tertiary hover:text-wc-text">Nosotros</a></li>
              <li><a href="/reto-rise" class="text-sm text-wc-text-tertiary hover:text-wc-text">RISE</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul class="mt-4 space-y-2.5">
              ...
              <li><a href="/politica-cookies" class="text-sm text-wc-text-tertiary hover:text-wc-text">Cookies</a></li>
              <li><a href="/reembolsos" class="text-sm text-wc-text-tertiary hover:text-wc-text">Reembolsos</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between gap-4 border-t border-wc-border py-6 sm:flex-row">
          <p class="text-xs text-wc-text-tertiary">&copy; {{ new Date().getFullYear() }} WellCore Fitness. Todos los derechos reservados.</p>
