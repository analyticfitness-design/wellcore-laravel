...
<template>
  <CoachLayout>
    <div class="space-y-6">
      ...
      <WcPageHeader contextLabel="MIS CLIENTES" title="CLIENTES" :subtitle="`${totalClients} cliente${totalClients !== 1 ? 's' : ''} activo${totalClients !== 1 ? 's' : ''}`">
        <template #actions>
          ...
          >
            ...
            <div class="hidden sm:flex items-center gap-2">
              ...
              <div class="flex items-center gap-1 rounded-full bg-wc-accent/10 px-2.5 py-1">
                ...
                <span class="text-[11px] font-semibold text-wc-accent">Nv. {{ client.xp_level || 1 }}</span>
              </div>
          ...
          <div v-show="expandedClient === client.id" class="border-t border-wc-border bg-wc-bg-secondary/30 px-4 py-4">
            ...
            <div class="mt-4 rounded-card border border-wc-border bg-wc-bg p-4">
              <div class="flex flex-wrap items-center justify-between gap-2">
                <div>
                  <p class="font-sans text-xs font-bold uppercase tracking-widest text-wc-text-secondary">Acciones restringidas</p>
