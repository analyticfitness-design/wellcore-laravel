...
// Heroicons stroke 1.6 — paths reusados del AdminSidebar legacy para mantener
// consistencia visual con la versión que Daniel ya validó.
const ICON_PATHS = {
...
const SECTIONS = [
  { label: 'General', items: [
    ...
    { name: 'Live Feed',    route: '/admin/feed',        icon: 'lightning', badge: '12' },
    { name: 'Clientes',     route: '/admin/clients',     icon: 'users' },
    { name: 'Formularios',  route: '/admin/formularios', icon: 'form' },
  ]},
  { label: 'Financiero', items: [
    ...
    { name: 'Invitaciones',  route: '/admin/invitations',    icon: 'mail' },
    { name: 'Comprobantes',  route: '/admin/payment-proofs', icon: 'check' },
  ]},
  { label: 'Equipo', items: [
    { name: 'Coaches', route: '/admin/coaches', icon: 'headset' },
  ]},
  { label: 'Marketing', items: [
    { name: 'Cola de Drops', route: '/admin/marketing/queue', icon: 'megaphone', pulse: true },
  ]},
  { label: 'Planes', items: [
    { name: 'Planes',       route: '/admin/plans',        icon: 'clipboard', badge: '75' },
    { name: 'Generador IA', route: '/admin/ai-generator', icon: 'sparkles' },
  ]},
  { label: 'RISE', items: [
    { name: 'RISE', route: '/admin/rise', icon: 'sparkles' },
  ]},
  { label: 'Comunicación', items: [
    { name: 'Comunidad',           route: '/admin/community',          icon: 'megaphone', isNew: true },
    { name: 'Chat Analytics',      route: '/admin/chat-analytics',     icon: 'chart' },
    { name: 'Tickets',             route: '/admin/tickets',            icon: 'ticket' },
    { name: 'Tickets de Planes',   route: '/admin/plan-tickets',       icon: 'ticket' },
    { name: 'Solicitudes Coaches', route: '/admin/client-requests',    icon: 'inbox' },
    { name: 'Stats de Tickets',    route: '/admin/plan-tickets/stats', icon: 'stats' },
  ]},
  { label: 'Growth', items: [
    { name: 'Campañas',  route: '/admin/campaigns', icon: 'target' },
    { name: 'Referidos', route: '/admin/referrals', icon: 'share' },
  ]},
  { label: 'Sistema', items: [
    { name: 'Herramientas',   route: '/admin/tools',         icon: 'wrench' },
    { name: 'Notificaciones', route: '/admin/notifications', icon: 'bell' },
    { name: 'Audit Log',      route: '/admin/audit-log',     icon: 'shield' },
    { name: 'Configuración',  route: '/admin/settings',      icon: 'settings' },
  ]},
];
