 ...
 *
 * Emits:
 *   start   user clicked "Tomar primera sesión"
 *   guide   user clicked "Ver guía"
 */
...
<template>
  ...
  >
    ...
    <h3 class="mx-auto max-w-[18ch] font-display text-3xl font-medium uppercase leading-[1.05] tracking-wide text-wc-text sm:text-4xl">
      Tu primer día
      <em class="not-italic font-normal text-wc-text-tertiary">queda guardado para siempre.</em>
    </h3>
    <p class="mx-auto mt-3.5 max-w-[48ch] text-sm text-wc-text-secondary sm:text-[15px]">
      Tres fotos, cinco minutos. Después vas a poder volver a esta misma página cada dos semanas y ver — literalmente — cómo cambia tu cuerpo.
    </p>
