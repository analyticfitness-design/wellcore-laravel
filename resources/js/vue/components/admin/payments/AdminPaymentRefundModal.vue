...
.form-textarea::placeholder { color: var(--color-wc-text-tertiary); }
...
.form-hint--ok { color: var(--color-wc-green-text, #34D399); }

.info-box {
    background: var(--color-wc-amber-soft, rgba(245, 158, 11, 0.07));
