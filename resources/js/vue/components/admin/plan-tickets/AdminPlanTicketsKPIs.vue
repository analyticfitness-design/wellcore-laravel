...
.kpi-card--urgent  { background: var(--c-accent-dim); border: 1px solid rgba(220,38,38,0.22); }
.kpi-card--warn    { background: var(--c-amber-dim); border: 1px solid rgba(212,168,14,0.22); }
.kpi-card--healthy { background: var(--c-success-dim); border: 1px solid rgba(22,163,74,0.22); }
.kpi-card--info    { background: var(--c-surface); border: 1px solid var(--c-border); }
...
@media (min-width: 1024px) {
    ...
    .kpi-value { font-size: var(--t-xl, 37px); }
}
