...
$dayTemplates = [
    ...
    'Martes' => [
        ...
        'ejercicios' => [
            ...
            [$g('plancha-abdominal'),                    'Plancha abdominal',                       'Glúteos apretados, cadera neutral. Si no aguantas, baja a rodillas.', ['repeticiones' => null, 'rir' => null]],
    ...
    'Miércoles' => [
        ...
        'ejercicios' => [
            [$g('puente-de-gluteo-con-mancuerna'),       'Puente de glúteo con mancuerna',       'Mancuerna en la cadera. Aprieta glúteos arriba y aguanta 1 seg antes de bajar.'],
            [$g('sentadilla-con-mancuernas'),            'Sentadilla sumo con mancuerna',        'Pies más abiertos que los hombros, punta hacia afuera. Mancuerna colgando al centro.'],
            ...
            [$g('elevacion-cadera-acostado-flexionado'), 'Elevación de cadera acostada',         'Boca arriba, piernas dobladas. Aprieta el glúteo en la parte alta, baja lento.'],
        ],
    ],
    'Jueves' => [
        ...
        'ejercicios' => [
            ...
            [$g('plancha-abdominal'),                         'Plancha abdominal',                      'Aguanta el tiempo indicado. Si no puedes, baja a rodillas sin romper la línea.', ['repeticiones' => null, 'rir' => null]],
            [$g('bicicleta-crunch'),                          'Bicicleta crunch',                       'Cuenta cada toque de codo a rodilla como 1 rep. Lento y controlado.', ['override_reps' => true]],
        ],
    ],
    'Viernes' => [
        ...
        'ejercicios' => [
            ...
            [$g('elevacion-cadera-acostado-flexionado'),      'Elevación de cadera acostada',               'Piernas dobladas, pies planos. Variante avanzada: a una sola pierna.'],
        ],
    ],
];
    ...
    'comidas' => [
        ...
        [
            ...
            'opcion_c' => [
                '2 huevos duros',
                '1 pera mediana (150g)',
                '1 vaso de leche descremada (240ml)',
            ],
            'notas' => 'Si entrenas por la tarde, toma esta merienda 1h antes del entreno. El shake (opción A) funciona bien como pre-workout.',
        ],
        [
            'nombre'   => 'Cena',
            'hora'     => '7:00 - 8:00 PM',
            ...
            'opcion_c' => [
                '3 huevos enteros en tortilla con vegetales salteados',
                '1/2 taza de frijoles negros cocidos (90g)',
                '1/4 de aguacate (40g)',
