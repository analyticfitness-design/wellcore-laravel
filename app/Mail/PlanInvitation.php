...
class PlanInvitation extends Mailable implements ShouldQueue
{
    ...
    {
        $baseUrl = rtrim(config('wellcore.base_url', config('app.url')), '/');
        ...
        return [
            ...
            'esencial' => [
                ...
                'priceSuffix' => 'COP/mes',
                'priceUsd' => '~$62 USD',
                'billingNote' => '$254.150 COP/mes (promo abril -15%). Cancela cuando quieras.',
            ...
            'metodo' => [
                ...
                'priceSuffix' => 'COP/mes',
                'priceUsd' => '~$82 USD',
                'billingNote' => '$339.150 COP/mes (promo abril -15%). Sin permanencia minima.',
            ...
            'elite' => [
                ...
                'priceSuffix' => 'COP/mes',
                'priceUsd' => '~$114 USD',
                'billingNote' => '$466.650 COP/mes (promo abril -15%). La inversion mas completa en tu transformacion.',
