    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (method_exists($response, 'header')) {
            $csp = implode('; ', [
                ...
                "connect-src 'self' https://api.anthropic.com https://sandbox.wompi.co https://production.wompi.co https://www.google-analytics.com https://www.facebook.com https://connect.facebook.net wss:",
