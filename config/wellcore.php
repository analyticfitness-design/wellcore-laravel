...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Progress Photos v2 Feature Flag (rollout gradual)
    |--------------------------------------------------------------------------
    | WC_PHOTOS_V2=false        — off para todos (default)
    | WC_PHOTOS_V2_PCT=10       — on para 10% de usuarios
    | WC_PHOTOS_V2_USERS=1,2,3  — forzar para user IDs específicos
    */
    'photos_v2' => [
        'enabled' => env('WC_PHOTOS_V2', false),
